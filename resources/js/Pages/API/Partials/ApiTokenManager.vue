              ...
              <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                ...
                <div class="flex items-center">
                  ...
                  <button v-if="availablePermissions.length > 0"
                          class="cursor-pointer ml-6 text-sm text-white underline"
    ...
    <jet-dialog-modal :show="displayingToken" @close="displayingToken = false">
      ...
      <template #content>
        ...
        <div v-if="$page.props.jetstream.flash.token"
             class="mt-4 bg-gray-100 px-4 py-2 rounded font-mono text-sm text-white">
    ...
    <jet-confirmation-modal :show="apiTokenBeingDeleted" @close="apiTokenBeingDeleted = null">
      ...
      <template #footer>
        ...
        <jet-danger-button :class="{ 'opacity-25': deleteApiTokenForm.processing }"
                           :disabled="deleteApiTokenForm.processing" class="ml-3"
