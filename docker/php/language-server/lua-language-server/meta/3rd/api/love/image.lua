...
---@param filename? string @ (default: `nil`) The filename to write the file to. If nil, no file will be written but the FileData will still be returned.
...
---@param x? number @ (default: `0`) The x-axis of the top-left corner of the area within the ImageData to apply the function to.
---@param y? number @ (default: `0`) The y-axis of the top-left corner of the area within the ImageData to apply the function to.
---@param width? number @ (default: `ImageData:getWidth()`) The width of the area within the ImageData to apply the function to.
---@param height? number @ (default: `ImageData:getHeight()`) The height of the area within the ImageData to apply the function to.
...
---@param width number @ The width of the ImageData.
---@param height number @ The height of the ImageData.
---@param format? PixelFormat @ (default: `'rgba8'`) The pixel format of the ImageData.
---@param data? string @ (default: `nil`) Optional raw byte data to load into the ImageData, in the format specified by ''format''.
---@return ImageData imageData @ The new ImageData object.
function image.newImageData(width, height, format, data) end
