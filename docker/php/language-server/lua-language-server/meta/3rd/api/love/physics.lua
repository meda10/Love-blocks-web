...
---@param index? number @ (default: `1`) A bounding box of the fixture.
...
---@param childIndex? number @ (default: `1`) The index of the child the ray gets cast against.
...
---@param childIndex? number @ (default: `1`) The index of the child to compute the bounding box of.
---@return number topLeftX @ The x position of the top-left point.
---@return number topLeftY @ The y position of the top-left point.
---@return number bottomRightX @ The x position of the bottom-right point.
---@return number bottomRightY @ The y position of the bottom-right point.
...
---@param velocityiterations? number @ (default: `8`) The maximum number of steps used to determine the new velocities when resolving a collision.
---@param positioniterations? number @ (default: `3`) The maximum number of steps used to determine the new positions when resolving a collision.
...
---@param x? number @ (default: `0`) The x position of the body.
---@param y? number @ (default: `0`) The y position of the body.
---@param type? BodyType @ (default: `'static'`) The type of the body.
...
---@param collideConnected? boolean @ (default: `false`) Specifies whether the two bodies should collide with each other.
...
---@param density? number @ (default: `1`) The density of the fixture.
...
---@param collideConnected? boolean @ (default: `false`) Specifies whether the two bodies should collide with each other.
---@return FrictionJoint joint @ The new FrictionJoint.
function physics.newFrictionJoint(body1, body2, x1, y1, x2, y2, collideConnected) end
...
---@param body1 Body @ The first body to attach to the joint.
---@param body2 Body @ The second body to attach to the joint.
---@param correctionFactor? number @ (default: `0.3`) The joint's initial position correction factor, in the range of 1.
...
function physics.newPolygonShape(x1, y1, x2, y2, x3, y3, ...) end
...
---@param ay number @ The y coordinate of the axis unit vector.
---@param collideConnected? boolean @ (default: `false`) Specifies whether the two bodies should collide with each other.
---@param referenceAngle? number @ (default: `0`) The reference angle between body1 and body2, in radians.
---@return PrismaticJoint joint @ The new prismatic joint.
...
---@param ratio? number @ (default: `1`) The joint ratio.
---@param collideConnected? boolean @ (default: `true`) Specifies whether the two bodies should collide with each other.
...
---@param width number @ The width of the rectangle.
---@param height number @ The height of the rectangle.
---@param angle? number @ (default: `0`) The initial angle of the rectangle.
---@return PolygonShape shape @ A new PolygonShape.
...
---@param collideConnected? boolean @ (default: `false`) Specifies whether the two bodies should collide with each other.
---@return WheelJoint joint @ The new WheelJoint.
function physics.newWheelJoint(body1, body2, x1, y1, x2, y2, ax, ay, collideConnected) end


---Creates a new World.
---@param xg? number @ (default: `0`) The x component of gravity.
---@param yg? number @ (default: `0`) The y component of gravity.
---@param sleep? boolean @ (default: `true`) Whether the bodies in this world are allowed to sleep.
