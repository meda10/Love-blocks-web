...
---@param left number @ Strength of the left vibration motor on the Joystick. Must be in the range of 1.
---@param right number @ Strength of the right vibration motor on the Joystick. Must be in the range of 1.
---@param duration? number @ (default: `-1`) The duration of the vibration in seconds. A negative value means infinite duration.
---@return boolean success @ True if the vibration was successfully applied, false if not.
...
function joystick.getGamepadMappingString(guid) end
...
---@param hatdir? JoystickHat @ (default: `nil`) The direction of the hat, if the virtual gamepad button will be bound to a hat. nil otherwise.
---@return boolean success @ Whether the virtual gamepad button was successfully bound.
function joystick.setGamepadMapping(guid, button, inputtype, inputindex, hatdir) end
...
---@param hatdir? JoystickHat @ (default: `nil`) The direction of the hat, if the virtual gamepad axis will be bound to a hat. nil otherwise.
---@return boolean success @ Whether the virtual gamepad axis was successfully bound.
function joystick.setGamepadMapping(guid, axis, inputtype, inputindex, hatdir) end
